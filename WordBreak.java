...
// O(n^2). Size of recursion tree can go up to n^2n ​2
public class Solution {
    public boolean wordBreak(String s, List<String> wordDict) {
...
// O(n^2). For every starting index, the search can continue till the end of the given string.
public class Solution {
    public boolean wordBreak(String s, List<String> wordDict) {
